...
description: >
  ...
  Studio como o Hamidi), ou disser algo como "quero adicionar X", "preciso
...
- Quando o requisito vem de um cliente da Async Studio (ex. Hamidi), o MoSCoW também serve para negociar escopo de contrato — "Won't" documentado evita expectativa mal alinhada depois.
