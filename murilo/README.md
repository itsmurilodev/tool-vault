...
- [SyncPay — Infraestrutura de Pagamentos, Pix, Recorrência e Automação via MCP](engenharia/ferramentas/sync-pay.md) — Gateway de pagamentos focado no mercado brasileiro com Pix instantâneo, Pix Automático, cartão tokenizado, split e servidor MCP nativo para agentes de IA.
